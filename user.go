...
func addUser(user User) error {
	...
	if err != nil {
		//return err
		return errors.New("Client create failed")
	}
...
func handlerSignup(w http.ResponseWriter, r *http.Request) {
	...
	if err := addUser(user); err != nil {
		...
		} else if err.Error() == "Client create failed" {
			http.Error(w, "Client create failed", http.StatusInternalServerError)
		} else if err.Error() == "Search failed" {
			http.Error(w, "Search failed", http.StatusInternalServerError)
		} else if err.Error() == "create user failed" {
