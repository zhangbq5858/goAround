...
const (
	POST_INDEX  = "post"
	POST_TYPE   = "post"
	ES_URL      = "http://35.190.171.205:9200"
	DISTANCE    = "200km"
	BUCKET_NAME = "around-annbb"
...
func handlerSearch(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Printf("Successfully read post from ElasticSearch %v.\n", posts)
...
func saveToBigTable(p *Post, id string) error {
	...
	bt_client, err := bigtable.NewClient(ctx, "dark-quasar-236002", "around-post")
	if err != nil {
		return err
	}
